...
export default function Marvelchar() {
      ...
      if (query === "") {
        ...
        if (
          ...
          const result = await axios(
            `http://gateway.marvel.com/v1/public/characters?orderBy=modified&limit=100&ts=1&apikey=239623db6bb1e571ce3329638b9145dc&hash=${hash}`
          );
        ...
        const result = await axios(
          `http://gateway.marvel.com/v1/public/characters?nameStartsWith=${query}&ts=1&apikey=239623db6bb1e571ce3329638b9145dc&hash=${hash}`
        );
        console.log(result.data.data.results);
        setItems(result.data.data.results);
        setLoading(false);
  ...
  return isLoading ? (
    ...
    <>
      ...
      <MDBCardTitle>
        <h1 style={{ margin: "2rem" }}>Marvel Characters</h1>
      </MDBCardTitle>
            ...
            <div className="cards">
              ...
              {/* <MDBCard>
                ...
                <MDBCardBody>
                  ...
                  <hr />
                  <MDBIcon far icon="clock" /> {item.modified}
